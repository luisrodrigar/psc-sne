...
library(rotasym)
source("perplexity.R")
source("prob_distribution.R")
source("high_dimension.R")
source("low_dimension.R")
...
result_excpected.radial = (as.numeric((t(z) %*% z)^(-1/2)) * (diag(length(z))-(radial_projection(z)%*%t(radial_projection(z)))))
