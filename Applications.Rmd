...
```{r cache=TRUE}
Y <- psc_sne(X=x_array, d=1, rho_psc_list = rho_first_20, num_iteration=125, colors=rep(c(1,2), each=nrow(x_array)/2), visualize_prog = TRUE, check = F)
```
...
vmf11 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = 0)), kappa = 10)
vmf12 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = pi)), kappa = 10)
vmf13 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = pi/2)), kappa = 10)
x1 <- sdetorus::toPiInt(cbind(DirStats::to_rad(vmf11),
                              DirStats::to_rad(vmf12),
...
vmf21 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = pi / 2)), kappa = 5)
vmf22 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = 0)), kappa = 5)
vmf23 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = pi)), kappa = 5)
x2 <- sdetorus::toPiInt(cbind(DirStats::to_rad(vmf21),DirStats::to_rad(vmf22), 
                              DirStats::to_rad(vmf23)))

vmf31 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = pi)), kappa = 30)
vmf32 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = 0)), kappa = 30)
vmf33 <- rotasym::r_vMF(n = n, mu = drop(DirStats::to_cir(th = pi/2)), kappa = 30)
...
shade3d(tmesh, color="gray")
points3d(x, color=rep(c(1,2,3), each=n))
```
