...
Y <- psc_sne(X=x_array, d=1, rho_psc_list = rho_first_20, num_iteration=500, 
...
```{r cache=TRUE, fig.asp=1}
Y <- psc_sne(X=x_array, d=2, rho_psc_list = rho_first_20, num_iteration=500,
...
Y <- psc_sne(X=x_2, d=1, rho_psc_list = rho_second_perp20, num_iteration=500,
             colors=colors, visualize_prog = TRUE)
```
...
```{r cache=TRUE, fig.height=10, fig.width=10}
Y <- psc_sne(X=x_2, d=2, rho_psc_list = rho_second_perp20, num_iteration=500,
             colors=colors, visualize_prog = TRUE)
```
...
```{r cache=TRUE, fig.height=10, fig.width=10}
Y <- psc_sne(X=x_3, d=1, rho_psc_list = rho_third_perp25, num_iteration=500,
             colors=colors, visualize_prog = TRUE)
```
...
```{r cache=TRUE, fig.height=10, fig.width=10}
Y <- psc_sne(X=x_3, d=2, rho_psc_list = rho_third_perp25, num_iteration=500,
             colors=colors, visualize_prog = TRUE)
```
...
```{r cache=TRUE, fig.height=10, fig.width=10}
Y <- psc_sne(X=x_4, d=1, rho_psc_list = rho_four_perp20, num_iteration=500, 
             visualize_prog = TRUE)
```
...
```{r cache=TRUE, fig.height=10, fig.width=10}
Y <- psc_sne(X=x_4, d=2, rho_psc_list = rho_four_perp20, num_iteration=500,
             visualize_prog = TRUE)
```
...
x_1_belt1 <- sphunif::r_alt(n = n, p = 3, alt = "SC", kappa = 200, nu = 0.9999)[,,1]
...
x_1_belt2 <- sphunif::r_alt(n = n, p = 3, alt = "SC", kappa = 200, nu = 0.89)[,,1]
...
x_1_belt3 <- sphunif::r_alt(n = n, p = 3, alt = "SC", kappa = 400, nu = 0.80)[,,1]
...
Y <- psc_sne(X=x_5, d=1, rho_psc_list = rho_five_perp20, num_iteration=500, eta = 20,
...
```{r fig.height=10, fig.width=10}
Y <- psc_sne(X=x_5, d=2, rho_psc_list = rho_five_perp20, num_iteration=500, eta = 400,
             visualize_prog = TRUE, colors = colors)
```
